...
- `scanRepo` from `src/scanner/scanRepo.ts:61`
...
- `src/scanner/scanRepo.ts:61` - A connected implementation file with both imports and exports. [Symbols: scanRepo@61]
...
- Start with `src/scanner/scanRepo.ts:61` if you are changing public behavior.
