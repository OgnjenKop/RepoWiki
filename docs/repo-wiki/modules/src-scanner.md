...
- `detectPackageManager` from `src/scanner/detectProject.ts:56`
- `detectProject` from `src/scanner/detectProject.ts:13`
- `detectProjectType` from `src/scanner/detectProject.ts:45`
