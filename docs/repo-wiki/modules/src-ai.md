...
- `ContextPackWriteOptions` from `src/ai/contextPacks.ts:223`
- `buildAreaContextPack` from `src/ai/contextPacks.ts:57`
- `buildModuleContextPack` from `src/ai/contextPacks.ts:121`
- `buildProjectContextPack` from `src/ai/contextPacks.ts:22`
- `buildRouteContextPack` from `src/ai/contextPacks.ts:174`
- `routeContextFileName` from `src/ai/contextPacks.ts:302`
- `routeContextKey` from `src/ai/contextPacks.ts:298`
- `sanitizePathFragment` from `src/ai/contextPacks.ts:306`
- `writeContextPacks` from `src/ai/contextPacks.ts:219`
- `writeContextPacksSelective` from `src/ai/contextPacks.ts:233`
...
- `AreaContextInput` from `src/ai/types.ts:64`
...
- `ModuleContextInput` from `src/ai/types.ts:59`
- `RouteContextInput` from `src/ai/types.ts:69`
- `SummaryBuildInput` from `src/ai/types.ts:54`
...
- Start with `src/ai/contextPacks.ts:57` if you are changing public behavior.
